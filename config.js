...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "INCONNU~XD~b1BSxYhD#7LoGTcpjvyWSS79YiCunGBntC-G2uifFBswcEdiZMXo",
...
BOT_NAME: process.env.BOT_NAME || "DARK-PRINCE-MD",
STICKER_NAME: process.env.STICKER_NAME || "DARK-PRINCE-MD",
CUSTOM_REACT: process.env.CUSTOM_REACT || "false", 
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹,❤️,🧡,💛,💚,💙,💜,🤎,🖤,🤍",
DELETE_LINKS: process.env.DELETE_LINKS || "false",
OWNER_NUMBER: process.env.OWNER_NUMBER || "554488138425",
OWNER_NAME: process.env.OWNER_NAME || "INCONNU DARK",
